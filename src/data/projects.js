    ...
    tech: [
      {
        ...
        desc: "수십 GB짜리 영상을 업로드하다가 중간에 끊기면 처음부터 다시 올려야 하는 문제가 있었습니다. 1MB 단위로 나눠 올리고 끊긴 지점을 서버에서 확인해 이어 올릴 수 있게 바꿨더니 50GB 이상 영상도 업로드 성공률 100%를 유지했습니다.",
      },
      {
      ...
      {
        name: "YOLO11 + 비동기 큐",
        desc: "영상을 프레임 단위로 분석하다 보니 서버가 그 연산에 묶여 다른 요청을 못 받는 상황이 생겼습니다. 탐지 작업을 별도 백그라운드 큐로 분리하고 가까운 시간대 탐지 결과는 자동으로 합쳐 DB에 쓰는 양도 줄였더니, 자원 사용량이 안정되고 24시간 영상을 30분 만에 분석할 수 있게 됐습니다(수작업 대비 4.5배).",
      },
      {
